...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            const excludeIds = ['user-info', 'close-btn','cancel-btn', 'close-filter-btn','profileLink', 'moreMisc-1', 'moreRich-1', 'insertTable-1', 'insertVideo-1', 'insertImage-1', '']; // Add more IDs as needed
