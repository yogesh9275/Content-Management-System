...
<script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
  ...
  <script>
    (function () {
        // Initialize TinyMCE
        tinymce.init({
            selector: '#edit',  // Apply the editor to the element with id 'edit'
            plugins: 'paste',  // Optional: Enable paste plugin
            toolbar: 'undo redo | bold italic | link | alignleft aligncenter alignright', // Customize toolbar if needed
            menubar: false, // Disable the menubar if unnecessary
            valid_elements: '*[*]', // Allow any content inside the editor
            setup: function(editor) {
                editor.on('init', function () {
                    const form = this.getElement().closest('form');
                    form.addEventListener('submit', function (e) {
                        const longText = tinymce.activeEditor.getContent();  // Get the HTML content from TinyMCE editor
