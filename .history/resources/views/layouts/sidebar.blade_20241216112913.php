    ...
    <div id="userprofile" class="position-relative" style="height: 100%">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="sidebar-link {{ request()->is('home*') ? 'active' : '' }}">
                    <a class="collapsed submenu" href="{{ route('home.index') }}">
                        <span class="icon">
                            <x-bi-newspaper class="icon-size" />
                        </span>
                        <span class="d-none d-md-inline">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item position-relative">
                    <div class="sidebar-link profile">
                        ...
                        <a id="profileLink" class="submenu d-flex align-items-center" data-bs-toggle="collapse" href="#profilesubmenu"
                            role="button" aria-expanded="false" aria-controls="profilesubmenu" style="cursor: pointer;">
