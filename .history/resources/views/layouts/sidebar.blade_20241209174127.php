<nav id="sidebar" class="col-md-3 col-lg-2 sidebar">
    <div id="userprofile" class="position-relative" style="height: 100%">
        <ul class="nav flex-column">
            ...
            @if (auth()->user()->can('Full control') ||
                    auth()->user()->can('create shop') ||
                    auth()->user()->can('view shop') ||
                    auth()->user()->can('edit shop') ||
                    auth()->user()->can('delete shop'))
                <li class="nav-item">
                    <div class="sidebar-link {{ request()->is('shop*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('shop') }}">
                            <span class="icon">
                    ...
                    <div id="shopSubmenu" class="collapse">
                        <ul class="nav flex-column">
                            ...
                            @if (auth()->user()->can('Full control') || auth()->user()->can('edit shop'))
                                <li class="nav-item">
                                    <a class="nav-link submenu-link" href="{{ route('shop') }}">
                                        <span>Edit Shop</span>
                                    </a>
                                </li>
                            @endif
            ...
            @if (auth()->user()->can('Full control') ||
                ...
                <li class="nav-item">
                    <div class="sidebar-link {{ request()->is('inventory*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('inventory') }}">
                            <span class="icon">
                    ...
                    <div id="inventorySubmenu" class="collapse">
                        <ul class="nav flex-column">
                            ...
                            @if (auth()->user()->can('Full control') || auth()->user()->can('edit inventory'))
                                <li class="nav-item">
                                    <a class="nav-link submenu-link" href="{{ route('inventory') }}">
            ...
            @if (auth()->user()->can('Full control') ||
                ...
                <li class="nav-item">
                    ...
                    <div class="sidebar-link {{ request()->is('sales*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('sales') }}">
                            <span class="icon">
                    ...
                    <div id="salesSubmenu" class="collapse">
                        <ul class="nav flex-column">
                            ...
                            @if (auth()->user()->can('Full control') || auth()->user()->can('edit sales'))
                                <li class="nav-item">
                                    <a class="nav-link submenu-link" href="{{ route('sales') }}">
                                        <span>Edit Sale</span>
                                    </a>
                                </li>
                            @endif
            ...
            @if (auth()->user()->can('Full control') ||
                ...
                <li class="nav-item">
                    <div class="sidebar-link {{ request()->is('purchase*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('purchase') }}">
                            <span class="icon">
                    ...
                    <div id="purchaseSubmenu" class="collapse">
                        <ul class="nav flex-column">
                            ...
                            @if (auth()->user()->can('Full control') || auth()->user()->can('edit purchase'))
                                <li class="nav-item">
                                    <a class="nav-link submenu-link" href="{{ route('purchase') }}">
            ...
            @if (auth()->user()->can('Full control') ||
                ...
                <li class="nav-item">
                    ...
                    <div class="sidebar-link {{ request()->is('expense*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('expense') }}">
                            <span class="icon">
                    ...
                    <div id="expenseSubmenu" class="collapse">
                        <ul class="nav flex-column">
                            ...
                            @if (auth()->user()->can('Full control') || auth()->user()->can('edit expense'))
                                <li class="nav-item">
                                    <a class="nav-link submenu-link" href="{{ route('expense') }}">
            ...
            @if (auth()->user()->can('Full control') ||
                ...
                <li class="nav-item">
                    ...
                    <div class="sidebar-link {{ request()->is('user*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('user') }}">
                            <span class="icon">
            ...
            @if (auth()->user()->can('Full control') || auth()->user()->can('view roles') || auth()->user()->can('view permissions'))
                <li class="nav-item">
                    <div
                        class="sidebar-link {{ request()->is('roles*') || request()->is('permissions*') ? 'active' : '' }}">
                        <a class="collapsed submenu" href="{{ route('roles.index') }}">
                            <span class="icon">
