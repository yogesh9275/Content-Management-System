...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            const excludeIds = ['user-info', 'close-btn','cancel-btn', 'close-filter-btn','profileLink', 'moreMisc-1', 'moreRich-1', 'insertTable-1', 'insertVideo-1', 'insertImage-1', 'insertLink-1', 'alignLeft-1', 'alignCenter-1', 'formatOLSimple-1', 'moreParagraph-1', 'moreText-1']; // Add more IDs as needed
