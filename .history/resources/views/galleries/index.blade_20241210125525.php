        ...
        @forelse ($galleries as $gallery)
            <div class="col-md-4 mb-4">
                ...
                <div class="card h-100 position-relative">
                    ...
                    <div class="card-body d-flex flex-column position-absolute w-100 h-100 top-0 left-0 bg-opacity-75 bg-dark p-3" style="opacity: 0; transition: opacity 0.3s ease;">
...
<style>
    ...
    .card:hover .card-body {
        opacity: 1; /* Show content when card is hovered */
    }
