...
@section('page')
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3 border-bottom">
            ...
            <a href="{{ route('galleries.create') }}" class="btn btn-success mb-3"><x-bi-plus class="Add-icon" />Add New Image</a>
        </div>
                        ...
                        <div class="card-body d-flex flex-column"
                            ...
                            <div class="actions d-flex align-items-center gap-2 mt-auto">
                                <form action="{{ route('galleries.edit', $gallery->id) }}" method="GET" class="d-inline">
                                    <button id="" type="submit" class="btn btn-warning btn-sm d-flex align-items-center">
