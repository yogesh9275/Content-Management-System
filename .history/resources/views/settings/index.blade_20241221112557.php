            ...
            @foreach ($settings as $item)
                <div class="col-md-12 mb-4">
                    <div class="card d-flex flex-row align-items-start">
                        ...
                        <div class="card-img-left bg-white text-white d-flex justify-content-center align-items-center" style="width: 165px; height: 165px;">
                            @if ($item->media)
                                ...
                                @elseif ($item->media == 'threads')
                                    <img src="{{ asset('social/threads.png') }}" alt="Threads" class="media-icon" style="max-width: 90%; max-height: 90%; object-fit: contain;">
                                    @elseif ($item->media == 'threads')
                                    <img src="{{ asset('social/threads.png') }}" alt="Threads" class="media-icon" style="max-width: 90%; max-height: 90%; object-fit: contain;">
                                    @elseif ($item->media == 'threads')
                                    <img src="{{ asset('social/threads.png') }}" alt="Threads" class="media-icon" style="max-width: 90%; max-height: 90%; object-fit: contain;">
