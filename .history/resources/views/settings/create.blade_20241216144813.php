        ...
        <form action="{{ route('settings.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="media" id="media" class="form-control" required>
                    ...
                    <option value="video" {{ old('media') == 'video' ? 'selected' : '' }}>WhatsApp</option>
                    <option value="image" {{ old('media') == 'image' ? 'selected' : '' }}>Facebook</option>
                    <option value="article" {{ old('media') == 'article' ? 'selected' : '' }}>Instagram</option>
