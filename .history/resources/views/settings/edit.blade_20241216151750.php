...
@section('page')
    <div class="container mt-4">
        ...
        <form action="{{ route('settings.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="url" name="links" id="links" class="form-control" value="{{ old('links', $settings->links) }}" required>
            </div>
