        ...
        <div class="shadow-sm p-4 rounded bg-white">
            ...
            @foreach ($elements as $element)
                <div class="card my-4" style="width: 100%;">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start border p-3 rounded">
                            <div>
                            <h5 class="card-title text-dark fw-bold" style="margin-bottom: ">{{ $element->element }}</h5>
                            </div>
