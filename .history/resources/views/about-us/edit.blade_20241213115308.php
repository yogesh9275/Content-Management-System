    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('about-us.update', $element->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Div for Image -->
<!-- Div for Image -->
<div class="mb-4 element-div position-relative" id="Image" style="{{ $element->element == 'Image' ? 'display:block;' : 'display:none;' }}">
    ...
    <!-- Image Preview -->
    <div class="mt-3" id="image-preview" style="display: {{ $element->element == 'Image' && $element->data ? 'block;' : 'none;' }}">
        <img id="preview-img" src="{{ $element->element == 'Image' && $element->data ? asset($element->data) : '' }}" class="img-thumbnail mb-2" alt="Image Preview" style="max-width: 100%; max-height: 20rem;">
    </div>
</div>
