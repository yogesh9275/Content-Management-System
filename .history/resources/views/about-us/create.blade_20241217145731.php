        ...
        <form action="{{ route('about-us.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" name="element" id="element" onchange="toggleDivs()" required>
                    ...
                    <option value="Long Text">2004</option>
                    <option value="Long Text">2014</option>
                    <option value="Long Text">2016</option>
                    <option value="Long Text">2018</option>
                    <option value="Long Text">2021</option>
                    <option value="Long Text">2024</option>
                </select>
            </div>
