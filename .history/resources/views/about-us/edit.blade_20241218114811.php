                ...
                <form action="{{ route('about-us.update', $element->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="element" id="element" onchange="toggleDivs()" required>
                            ...
                            <option value="about-header" {{ $element->element == 'about-header' ? 'selected' : '' }}>About Header
                            </option>
                            <option value="about-image" {{ $element->element == 'about-image' ? 'selected' : '' }}>About Image</option>
                    ...
                    <div class="mb-4 element-div" id="about-header" style="display:none;">
                        ...
                        <input type="text" class="form-control" name="about-data-header" id="data-header"
                            value="{{ $element->data }}">
                    </div>
