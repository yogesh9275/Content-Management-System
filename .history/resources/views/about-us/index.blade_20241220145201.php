    ...
    <div class="container mt-5">
        <div class="shadow-sm p-4 rounded bg-white">
            <div class="d-flex justify-content-between align-items-center border-bottom pb-3">
                ...
                <a id="Add-btn" href="{{ route('about-us.create') }}" class="btn btn-primary"><x-bi-plus
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center border p-3 rounded">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <form action="{{ route('about-us.destroy', $element->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @if ($element->element == 'image' || $element->element == 'about-image')
                            <img src="{{ url('admin/' . $gallery->path) }}{{ asset($element->data) }}" alt="Image" class="img-fluid rounded shadow-sm mt-3"
