    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('about-us.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4 element-div" id="2016" style="display:none;">
                ...
                <textarea class="form-control" name="data-paragraph-216" id="data-paragraph-2016" rows="5"></textarea>
            ...
            <div class="mb-4 element-div" id="2018" style="display:none;">
                ...
                <textarea class="form-control" name="data-paragraph-218" id="data-paragraph-2018" rows="5"></textarea>
            ...
            <div class="mb-4 element-div" id="2024" style="display:none;">
                ...
                <textarea class="form-control" name="data-paragraph-20" id="data-paragraph-2024" rows="5"></textarea>
