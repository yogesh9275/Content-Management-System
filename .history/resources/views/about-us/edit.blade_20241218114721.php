                ...
                <form action="{{ route('about-us.update', $element->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="element" id="element" onchange="toggleDivs()" required>
                            ...
                            <option value="Long Text" {{ $element->element == 'about-header' ? 'selected' : '' }}>About Header
                            </option>
                            <option value="about-image" {{ $element->element == 'about-header' ? 'selected' : '' }}>About Image</option>
