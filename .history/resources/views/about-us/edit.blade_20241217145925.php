                ...
                <form action="{{ route('about-us.update', $element->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="element" id="element" onchange="toggleDivs()" required>
                            ...
                            <option value="{{}}" {{ $element->element == '2004' ? 'selected' : '' }}>Image</option>
                            <option value="Image" {{ $element->element == '2016' ? 'selected' : '' }}>Image</option>
                            <option value="Image" {{ $element->element == '2018' ? 'selected' : '' }}>Image</option>
                            <option value="Image" {{ $element->element == '2021' ? 'selected' : '' }}>Image</option>
                            <option value="Image" {{ $element->element == '2024' ? 'selected' : '' }}>Image</option>
                        </select>
                    </div>
