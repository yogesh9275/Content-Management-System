    ...
    <script>
        (function() {
            ...
            var quill = new Quill('#edit', {
                theme: 'snow', // Use 'snow' theme, you can also use 'bubble'
                modules: {
                    toolbar: [
            ...
            // Ensure the Quill editor content is updated in the hidden input before submitting the form
            const form = document.querySelector('form');
            if (form) {
                form.addEventListener('submit', function(e) {
                    const longText = quill.root.innerHTML; // Get the HTML content from Quill editor

                    // Set the content of the hidden input field to the Quill content
