    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <!-- Make sure to output the news content inside the editor -->
                <div id="details" class="summernote" name="details" required>{!! old('details', $news->details) !!}</div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#details').summernote({
                ...
                codemirror: {  // Enable codeview to directly edit HTML
                    theme: 'monokai'
                }
            });
