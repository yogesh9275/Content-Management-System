...
<div class="container mt-4">
    ...
    <a id="Add-btn" href="{{ route('news.create') }}" class="btn btn-primary mb-3">Add News</a>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="actions d-flex justify-content-end gap-2 mt-auto">
                                ...
                                <form action="{{ route('news.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button id="edit-btn" type="submit" class="btn btn-danger btn-sm d-flex align-items-center" onclick="return confirm('Are you sure?')">
