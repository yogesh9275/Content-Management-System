                ...
                <div class="mt-5">
                    ...
                    <div class="row mb-4">
                        @foreach ($homePages as $homePage)
                            @if (Str::startsWith($homePage->element, 'slider-image-')) <!-- Only proceed for slider-* values -->
                                <div class="col-12">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center border p-3 rounded">
                                            ...
                                            <!-- Check if the element starts with "slider-image-" (e.g., slider-image-1, slider-2, etc.) -->
