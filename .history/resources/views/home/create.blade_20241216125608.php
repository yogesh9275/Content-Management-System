...
@section('page')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            handleImageUpload('data-about-image', 'cancel-btn', 'preview-img', 'about-file-size-error'); // Handle About Image
            handleImageUpload('data-image', 'about-cancel-btn', 'preview-img', 'about-file-size-error'); // Handle Regular Image
