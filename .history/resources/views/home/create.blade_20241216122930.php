...
@section('page')
    <div class="container mt-5">
        ...
        <form action="{{ route('homepage.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4 element-div" id="About-Description" style="display:none;">
                ...
                <div id="about-word-count-error" class="text-danger" style="display: none;">About description exceeds the word limit. Please shorten it.</div>
    ...
    <script>
        ...
        var originalImageSrc = '{{ asset('images/default-image.png') }}';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            toggleDivs();
            updateWordCount('data-description', 'word-count-display', 'word-count-error', 250); // Set word count logic for regular description
            updateWordCount('data-about-description', 'about-word-count-display', 'about-word-count-error', 150); // Set word count logic for about description
        });
