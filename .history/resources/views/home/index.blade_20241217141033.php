                ...
                <div class="mt-5">
                    ...
                    <div class="row mb-4">
                        @foreach ($homePages as $homePage)
                            <!-- Use preg_match to check if the element is in the form of 'slider-image-' followed by any digits -->
                            @if (preg_match('/^slider-image-\d+$/', $homePage->element))
                                <div class="col-12">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <div
                                            ...
                                            <!-- Check if the element is a slider-image-* -->
                                            @if (preg_match('/^slider-image-\d+$/', $homePage->element))
