...
@section('page')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            handleImageUpload('data-vision-image', 'vision-cancel-btn', 'preview-img', 'vision-file-size-error'); // Handle Vision Image
            handleImageUpload('data-slider-image', 'slider-cancel-btn', 'preview-img', 'slider-file-size-error'); // Handle Slider Image
            ...
            // Add custom redirect logic to the back button based on element type
            ...
            backBtn.addEventListener('click', function(e) {
                ...
                // Check the selected element and redirect accordingly
                if (['title', 'description', 'image'].includes(elementType)) {
                    redirectTo = '/homepage';
                } else if (['vision-title', 'vision-description', 'vision-image'].includes(elementType)) {
                    redirectTo = '/homepage/vision';
                } else if (['about-title', 'about-description', 'about-image'].includes(elementType)) {
                    redirectTo = '/homepage/about';
                } else if (elementType === 'slider-image') {
                    redirectTo = '/homepage/slider';
                }

                // Perform the redirection to the appropriate URL
