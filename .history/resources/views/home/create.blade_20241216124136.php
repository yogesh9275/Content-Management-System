...
document.addEventListener('DOMContentLoaded', function() {
    toggleDivs();
    updateWordCount('data-description', 'word-count-display', 'word-count-error', 250); // Regular description
    updateWordCount('data-about-description', 'about-word-count-display', 'about-word-count-error', 250); // About description
});
