                ...
                <form action="{{ route('homepage.update', $homePage->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="element" id="element" onchange="toggleDivs()" required>
                            ...
                            <option value="vision-title" {{ $homePage->element == 'vision-title' ? 'selected' : '' }}>About-Title</option>
                            <option value="vision-description" {{ $homePage->element == 'vision-description' ? 'selected' : '' }}>About-Description</option>
                            <option value="vision-image" {{ $homePage->element == 'vision-image' ? 'selected' : '' }}>About-Image</option>
                        </select>
                    </div>
