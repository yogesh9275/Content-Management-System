        ...
        <div class="shadow-sm p-4 rounded bg-white">
            ...
            <div class="mt-5">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <span class="mx-3 text-muted">Title, Description, and Image</span>
                    <div class="border-top flex-grow-1"></div>
                </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    @if ($homePage->element == 'image')
                                        <img src="{{ asset($homePage->data) }}" alt="Image" class="img-fluid rounded shadow-sm mt-3" style="max-width: 50%; max-height: 50%;">
                                    @else
                                        @php
                                            $data = $homePage->data;
                                            $isHTML = false;
            ...
            <div class="mt-5">
                <div class="d-flex align-items-center mb-3">
                    <div class="border-top flex-grow-1"></div>
                    <span class="mx-3 text-muted">About Elements</span>
                    <div class="border-top flex-grow-1"></div>
                </div>
            ...
            <div class="mt-5">
                <div class="d-flex align-items-center mb-3">
                    <div class="border-top flex-grow-1"></div>
                    <span class="mx-3 text-muted">Vision Elements</span>
                    <div class="border-top flex-grow-1"></div>
                </div>
            ...
            <div class="mt-5">
                <div class="d-flex align-items-center mb-3">
                    <div class="border-top flex-grow-1"></div>
                    <span class="mx-3 text-muted">Slider Images</span>
                    <div class="border-top flex-grow-1"></div>
                </div>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    @if ($homePage->element == 'slider-image')
                                        <img src="{{ asset($homePage->data) }}" alt="Slider Image" class="img-fluid rounded shadow-sm mt-3" style="max-width: 50%; max-height: 50%;">
                                    @endif
                                </div>
                            </div>
                        </div>
