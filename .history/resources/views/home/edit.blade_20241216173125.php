            ...
            <div class="col-12">
                ...
                <form action="{{ route('homepage.update', $homePage->id) }}" method="POST" enctype="multipart/form-data" id="edit-form">
                    ...
                    <div class="mt-3" id="vision-image-preview" style="display: {{ $homePage->element == 'vision-image' && $homePage->data ? 'block' : 'none' }};">
                        <img id="vision-preview-img" src="{{ $homePage->element == 'About-Image' && $homePage->data ? asset($homePage->data) : '' }}" class="img-thumbnail mb-2" alt="Image Preview" style="max-width: 100%; max-height: 100%;">
                    </div>
