<script>
        ...
        // Ensure content from the Quill editor is added to the hidden input before form submission
        document.querySelector('form').addEventListener('submit', function(e) {
            const longText = quill.root.innerHTML; // Get the HTML content from Quill editor
            document.getElementById('details').value = longText; // Populate the hidden 'details' input
        });
    </script>
