...
document.addEventListener("DOMContentLoaded", function () {
    ...
    handleImageUpload(
        "data-vision-image", "vision-cancel-btn", "preview-img", "vision-file-size-error", document.getElementById("preview-img").src
    );
    handleImageUpload(
        "data-slider-image", "slider-cancel-btn", "preview-img", "slider-file-size-error", document.getElementById("preview-img").src
    );
    handleImageUpload(
        "data-image", "cancel-btn", "preview-img", "about-file-size-error", document.getElementById("preview-img").src
    );
