...
Route::get('/uploads/gallery/{filename}', function ($filename) {
...
Route::get('/uploads/home/{filename}', function ($filename) {
    // Add the slash between 'uploads/home' and the filename
    $path = base_path('uploads/home/' . $filename);
    ...
    // Return the file response with the correct content type
    return response($file, 200)->header('Content-Type', $type);
});
