...
class HomePageController extends Controller
{
    ...
    public function slider()
    {
        ...
        $homePages = HomePage::where('element', 'LIKE', 'Slider-%')->get();
    ...
    public function store(Request $request)
    {
        ...
        } elseif ($request->hasFile('data-vision-image') && $request->input('element') === 'About-Image') {
            Log::info('About Image file uploaded.');
            $filePath = $this->handleFileUpload($request, 'data-about-image');
        }elseif ($request->hasFile('data-slider-image') && $request->input('element') === 'About-Image') {
            Log::info('About Image file uploaded.');
            $filePath = $this->handleFileUpload($request, 'data-about-image');
        }
