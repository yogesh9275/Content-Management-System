    ...
    public function store(Request $request)
{
    ...
    // Perform validations and log each one
    try {
        // Validate the element type
        $request->validate([
            'element' => 'required|string',
            'data-header' => 'required_if:element,Header|string', // Required if element is Header
            'data-paragraph' => 'required_if:element,Paragraph|string', // Required if element is Paragraph
            'data-image' => 'required_if:element,Image|file|mimes:jpeg,png,jpg,gif,webp,svg|max:10240', // Required if element is Image and must be a valid image file
            'data-video' => 'required_if:element,Video|file|mimes:mp4,avi,mkv,webm|max:10240', // Required if element is Video and must be a valid video file
            'data-long-text' => 'required_if:element,Long Text|string', // Required if element is Long Text
        ]);
        ...
        throw $e;  // Re-throw the validation exception to return error response to the user
    }
