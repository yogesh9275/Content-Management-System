    ...
    public function store(Request $request)
{
    ...
    if ($request->hasFile('data-image') && $request->input('element') === 'Image') {
        $filePath = $request->file('data-image')->store('uploads', 'public');  // Store the image in the 'public/uploads' directory
    } elseif ($request->hasFile('data-video') && $request->input('element') === 'Video') {
        $filePath = $request->file('data-video')->store('uploads', 'public');  // Store the video in the 'public/uploads' directory
    }
