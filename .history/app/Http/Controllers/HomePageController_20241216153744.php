...
class HomePageController extends Controller
{
    ...
    {
        $homePages = HomePage::all();
        return view('home.about-section', compact('homePages'));
    }
    ...
    public function edit($id)
    {
     ...
     // This method is needed by Route::resource() for the 'show' route.
     public function show($id)
     {
         // Retrieve the homepage content by $id (or handle the case where $id isn't found)
         $homepage = Homepage::findOrFail($id);
