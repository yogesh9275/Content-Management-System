...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Determine whether to use links or details based on media type
        $data = [
            'media' => $request->media,
            'links' => $request->media === 'style' || $request->media === 'script' ? null : $request->links,
            'details' => $request->media === 'style' || $request->media === 'script' ? $request->details : null,
        ];
