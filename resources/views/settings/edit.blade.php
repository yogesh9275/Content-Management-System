        ...
        <form action="{{ route('settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="media" id="media" class="form-control" required>
                    ...
                    <option value="threads" {{ old('media', $setting->media) == 'threads' ? 'selected' : '' }}>Threads</option>
                </select>
            </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button id="update-btn" type="submit" class="btn btn-success">Update Account</button>
            </div>
        </form>
    </div>
@endsection
